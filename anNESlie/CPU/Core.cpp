...
#pragma region OpcodesBinding
	...
	opcodes[0x00].action = std::bind(&CPUCore::BRK, this);
	...
	opcodes[0x01].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x05].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x06].action = std::bind(&CPUCore::ASL, this);
	...
	opcodes[0x08].action = std::bind(&CPUCore::PHP, this);
	...
	opcodes[0x09].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x0A].action = std::bind(&CPUCore::ASL, this);
	...
	opcodes[0x0B].action = std::bind(&CPUCore::ANC, this);
	...
	opcodes[0x0D].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x0E].action = std::bind(&CPUCore::ASL, this);
	...
	opcodes[0x10].action = std::bind(&CPUCore::BPL, this);
	...
	opcodes[0x11].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x15].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x16].action = std::bind(&CPUCore::ASL, this);
	...
	opcodes[0x18].action = std::bind(&CPUCore::CLC, this);
	...
	opcodes[0x19].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x1A].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0x1D].action = std::bind(&CPUCore::ORA, this);
	...
	opcodes[0x1E].action = std::bind(&CPUCore::ASL, this);
	...
	opcodes[0x20].action = std::bind(&CPUCore::JSR, this);
	...
	opcodes[0x21].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x24].action = std::bind(&CPUCore::BIT, this);
	...
	opcodes[0x25].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x26].action = std::bind(&CPUCore::ROL, this);
	...
	opcodes[0x28].action = std::bind(&CPUCore::PLP, this);
	...
	opcodes[0x29].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x2A].action = std::bind(&CPUCore::ROL, this);
	...
	opcodes[0x2B].action = std::bind(&CPUCore::ANC, this);
	...
	opcodes[0x2C].action = std::bind(&CPUCore::BIT, this);
	...
	opcodes[0x2D].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x2E].action = std::bind(&CPUCore::ROL, this);
	...
	opcodes[0x30].action = std::bind(&CPUCore::BMI, this);
	...
	opcodes[0x31].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x35].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x36].action = std::bind(&CPUCore::ROL, this);
	...
	opcodes[0x38].action = std::bind(&CPUCore::SEC, this);
	...
	opcodes[0x39].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x3A].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0x3D].action = std::bind(&CPUCore::AND, this);
	...
	opcodes[0x3E].action = std::bind(&CPUCore::ROL, this);
	...
	opcodes[0x40].action = std::bind(&CPUCore::RTI, this);
	...
	opcodes[0x41].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x45].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x46].action = std::bind(&CPUCore::LSR, this);
	...
	opcodes[0x48].action = std::bind(&CPUCore::PHA, this);
	...
	opcodes[0x49].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x4A].action = std::bind(&CPUCore::LSR, this);
	...
	opcodes[0x4B].action = std::bind(&CPUCore::ALR, this);
	...
	opcodes[0x4C].action = std::bind(&CPUCore::JMP, this);
	...
	opcodes[0x4D].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x4E].action = std::bind(&CPUCore::LSR, this);
	...
	opcodes[0x50].action = std::bind(&CPUCore::BVC, this);
	...
	opcodes[0x51].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x55].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x56].action = std::bind(&CPUCore::LSR, this);
	...
	opcodes[0x58].action = std::bind(&CPUCore::CLI, this);
	...
	opcodes[0x59].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x5A].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0x5D].action = std::bind(&CPUCore::EOR, this);
	...
	opcodes[0x5E].action = std::bind(&CPUCore::LSR, this);
	...
	opcodes[0x60].action = std::bind(&CPUCore::RTS, this);
	...
	opcodes[0x61].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x65].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x66].action = std::bind(&CPUCore::ROR, this);
	...
	opcodes[0x68].action = std::bind(&CPUCore::PLA, this);
	...
	opcodes[0x69].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x6A].action = std::bind(&CPUCore::ROR, this);
	...
	opcodes[0x6B].action = std::bind(&CPUCore::ARR, this);
	...
	opcodes[0x6C].action = std::bind(&CPUCore::JMP, this);
	...
	opcodes[0x6D].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x6E].action = std::bind(&CPUCore::ROR, this);
	...
	opcodes[0x70].action = std::bind(&CPUCore::BVS, this);
	...
	opcodes[0x71].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x75].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x76].action = std::bind(&CPUCore::ROR, this);
	...
	opcodes[0x78].action = std::bind(&CPUCore::SEI, this);
	...
	opcodes[0x79].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x7A].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0x7D].action = std::bind(&CPUCore::ADC, this);
	...
	opcodes[0x7E].action = std::bind(&CPUCore::ROR, this);
	...
	opcodes[0x80].action = std::bind(&CPUCore::SKB, this);
	...
	opcodes[0x81].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x82].action = std::bind(&CPUCore::SKB, this);
	...
	opcodes[0x84].action = std::bind(&CPUCore::STY, this);
	...
	opcodes[0x85].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x86].action = std::bind(&CPUCore::STX, this);
	...
	opcodes[0x88].action = std::bind(&CPUCore::DEY, this);
	...
	opcodes[0x89].action = std::bind(&CPUCore::SKB, this);
	...
	opcodes[0x8A].action = std::bind(&CPUCore::TXA, this);
	...
	opcodes[0x8C].action = std::bind(&CPUCore::STY, this);
	...
	opcodes[0x8D].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x8E].action = std::bind(&CPUCore::STX, this);
	...
	opcodes[0x90].action = std::bind(&CPUCore::BCC, this);
	...
	opcodes[0x91].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x94].action = std::bind(&CPUCore::STY, this);
	...
	opcodes[0x95].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x96].action = std::bind(&CPUCore::STX, this);
	...
	opcodes[0x98].action = std::bind(&CPUCore::TYA, this);
	...
	opcodes[0x99].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0x9A].action = std::bind(&CPUCore::TXS, this);
	...
	opcodes[0x9D].action = std::bind(&CPUCore::STA, this);
	...
	opcodes[0xA0].action = std::bind(&CPUCore::LDY, this);
	...
	opcodes[0xA1].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xA2].action = std::bind(&CPUCore::LDX, this);
	...
	opcodes[0xA4].action = std::bind(&CPUCore::LDY, this);
	...
	opcodes[0xA5].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xA6].action = std::bind(&CPUCore::LDX, this);
	...
	opcodes[0xA8].action = std::bind(&CPUCore::TAY, this);
	...
	opcodes[0xA9].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xAA].action = std::bind(&CPUCore::TAX, this);
	...
	opcodes[0xAB].action = std::bind(&CPUCore::ATX, this);
	...
	opcodes[0xAC].action = std::bind(&CPUCore::LDY, this);
	...
	opcodes[0xAD].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xAE].action = std::bind(&CPUCore::LDX, this);
	...
	opcodes[0xB0].action = std::bind(&CPUCore::BCS, this);
	...
	opcodes[0xB1].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xB4].action = std::bind(&CPUCore::LDY, this);
	...
	opcodes[0xB5].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xB6].action = std::bind(&CPUCore::LDX, this);
	...
	opcodes[0xB8].action = std::bind(&CPUCore::CLV, this);
	...
	opcodes[0xB9].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xBA].action = std::bind(&CPUCore::TSX, this);
	...
	opcodes[0xBC].action = std::bind(&CPUCore::LDY, this);
	...
	opcodes[0xBD].action = std::bind(&CPUCore::LDA, this);
	...
	opcodes[0xBE].action = std::bind(&CPUCore::LDX, this);
	...
	opcodes[0xC0].action = std::bind(&CPUCore::CPY, this);
	...
	opcodes[0xC1].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xC2].action = std::bind(&CPUCore::SKB, this);
	...
	opcodes[0xC4].action = std::bind(&CPUCore::CPY, this);
	...
	opcodes[0xC5].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xC6].action = std::bind(&CPUCore::DEC, this);
	...
	opcodes[0xC8].action = std::bind(&CPUCore::INY, this);
	...
	opcodes[0xC9].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xCA].action = std::bind(&CPUCore::DEX, this);
	...
	opcodes[0xCC].action = std::bind(&CPUCore::CPY, this);
	...
	opcodes[0xCD].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xCE].action = std::bind(&CPUCore::DEC, this);
	...
	opcodes[0xD0].action = std::bind(&CPUCore::BNE, this);
	...
	opcodes[0xD1].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xD5].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xD6].action = std::bind(&CPUCore::DEC, this);
	...
	opcodes[0xD8].action = std::bind(&CPUCore::CLD, this);
	...
	opcodes[0xD9].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xDA].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0xDD].action = std::bind(&CPUCore::CMP, this);
	...
	opcodes[0xDE].action = std::bind(&CPUCore::DEC, this);
	...
	opcodes[0xE0].action = std::bind(&CPUCore::CPX, this);
	...
	opcodes[0xE1].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xE2].action = std::bind(&CPUCore::SKB, this);
	...
	opcodes[0xE4].action = std::bind(&CPUCore::CPX, this);
	...
	opcodes[0xE5].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xE6].action = std::bind(&CPUCore::INC, this);
	...
	opcodes[0xE8].action = std::bind(&CPUCore::INX, this);
	...
	opcodes[0xE9].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xEA].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0xEB].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xEC].action = std::bind(&CPUCore::CPX, this);
	...
	opcodes[0xED].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xEE].action = std::bind(&CPUCore::INC, this);
	...
	opcodes[0xF0].action = std::bind(&CPUCore::BEQ, this);
	...
	opcodes[0xF1].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xF5].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xF6].action = std::bind(&CPUCore::INC, this);
	...
	opcodes[0xF8].action = std::bind(&CPUCore::SED, this);
	...
	opcodes[0xF9].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xFA].action = std::bind(&CPUCore::NOP, this);
	...
	opcodes[0xFD].action = std::bind(&CPUCore::SBC, this);
	...
	opcodes[0xFE].action = std::bind(&CPUCore::INC, this);
