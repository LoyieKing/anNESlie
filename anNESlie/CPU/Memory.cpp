...
{
	char* memory_pointer = memoryHandler.GetMemoryAdress();
	...
	memoryHandler.SetWriteHandler(0x0000, 0x1FFF, [memory_pointer](int adress, char value) {memory_pointer[adress & 0x07FF] = value; });
